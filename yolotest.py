...
# model.predict(
# 'E:\\work\\highstakes\\maxresdefault.jpg', save = True, hide_labels=True, hide_conf=True)
# model.predict('E:\\work\\highstakes\\training_data_detect_ring\\valid\\images\\
# image_jpg.rf.b373a82ad9b08e583772f0b505beacf2.jpg', save = True)
